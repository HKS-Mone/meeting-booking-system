        ...
        >
          <div className="flex items-center justify-between w-full">
            <div className={`flex items-center gap-2 ${sidebarCollapsed ? 'md:justify-center md:w-full lg:justify-start lg:w-auto' : ''}`}>
              ...
              <div
                className="w-9 h-9 rounded-xl flex items-center justify-center shrink-0 transition-all duration-300 hover:rotate-12 hover:scale-110"
                style={{
            ...
            {!sidebarCollapsed && (
              <button
                onClick={toggleSidebar}
                className="md:hidden w-10 h-10 flex items-center justify-center rounded-xl text-white/80 hover:text-white hover:bg-white/10 transition-all duration-150"
          ...
          <button
            onClick={toggleSidebar}
            className="hidden md:flex mt-3 w-full items-center gap-2 py-2.5 rounded-xl text-xs font-medium text-white/70 hover:text-white hover:bg-white/8 transition-all duration-150 justify-center border border-white/0 hover:border-white/10"
